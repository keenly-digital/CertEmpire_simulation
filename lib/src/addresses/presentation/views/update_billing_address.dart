        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildTitle("Country / Region", true),
              ...
              _buildPlainTextField(streetAddress, obscure: true),
              _buildPlainTextField(streetAddress2, obscure: true),

              _buildTitle("Town / City", false),
              _buildPlainTextField(townCity, obscure: true),
              _buildTitle("State / Country", false),
              _buildPlainTextField(state, obscure: true),
              _buildTitle("Post Code / ZIP", false),
              _buildPlainTextField(postCode, obscure: true),
              _buildTitle("Phone", false),
              _buildPlainTextField(phone, obscure: true),
              _buildTitle("Email address", false),
              _buildPlainTextField(email, obscure: true),
